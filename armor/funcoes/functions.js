...
const banner2 = cfonts.render((`Akira`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`PUDIM-BOT`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const authorname = "Pudim-Bot - By: Akira"
const packname = "Créditos da base: Victor Gabriel"

const chyt = "553899645151@s.whatsapp.net";
const nit = "553899645151@s.whatsapp.net";
const supre = "553899645151@s.whatsapp.net";
